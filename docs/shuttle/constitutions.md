...
| Codex | `codex-astra`, `codex-sol`, `codex-terra`, `codex-luna` | Launched with `--approve-for-me`: approval requests go to Codex's automatic reviewer inside the workspace-write sandbox. |
