...
export function injectAppDialogStyles(): void {
...
export interface AppDialogProps {
  ...
  eyebrow?: ReactNode
  /** Optional italic gloss under the title. Leave it out unless it says
   *  something the form itself doesn't — a subtitle that restates a
