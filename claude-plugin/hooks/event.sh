...
# lib/shuttle/sent_files.ex tail. It also offers queued peer context on supported
# Claude and Codex hooks, without continuing Stop events. It exits 0 on every
# path and writes nothing at all on a host with no Shuttle state directory. See
