...
After extraction is complete, run the exit interview. Read [exit-interview.md](exit-interview.md) for the instrument, output template, and where the interview fiber belongs.
